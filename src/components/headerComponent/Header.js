      ...
      <header className="z-40 relative bg-black lg:opacity-100 opacity-90">
        <div className="hidden container lg:flex justify-between px-10 py-4 mx-auto text-white">
          ...
          <div className="flex items-center space-x-3 text-sm">
            ...
            <a
              href="https://www.linkedin.com/in/jane-obianaba-aa092413b/"
        ...
        <nav className="container  mx-auto flex items-center justify-between text-white h-28 lg:h-32 px-8 md:px-10">
          <div className=" ">
            <h1 className="cursor-pointer text-2xl lg:text-xl font-bold">
              JANEWEB
              <span className="text-yellow-600">PORTFOLIO</span>
            </h1>
          </div>
          <ul
            className={`bg-black  justify-center items-center lg:bg-transparent absolute h-screen lg:h-auto lg:static top-0 w-full lg:w-auto flex-col flex lg:flex lg:flex-row space-y-8 lg:space-y-0 lg:space-x-6 ${
